...
SELECT e.emp_id, e.emp_name, e.jobtitle_name, a.in_time, (CASE WHEN TO_CHAR (in_time, 'HH24:MI') > '09:00' THEN 'Late'
                                                            ELSE 'On Time' END) LATE
FROM emp e JOIN attendance a
ON e.emp_id = a.emp_id
WHERE TO_CHAR(a.attendance_date, 'DD-MON-YYYY') = '01-JAN-2021'
...
AND TO_CHAR(a.Attendance_date, 'DD-MON-YYYY') > '01-JAN-2018'
AND a.Attendance_status = 'P'
GROUP BY  e.Emp_id, e.Emp_name, j.Jobtitle_name
...
AND TO_CHAR(a.Attendance_date, 'DD-MON-YYYY') BETWEEN '01-JAN-2019' AND '31-JAN-2019';
...
TO_CHAR(SYSDATE, 'DD-MON-YYYY') - TO_CHAR(e.Join_date, 'DD-MON-YYYY') "Job Duration"
...
FROM Emp e, Jobtitle j, Dept d
WHERE e.Jobtitle_no = j.Jobtitle_no AND e.Dept_no = d.Dept_no
AND TO_CHAR(e.Join_date, 'DD-MON-YYYY') > '31-JAN-2019'
AND TO_CHAR(SYSDATE, 'DD-MON-YYYY') - TO_CHAR(e.Join_date, 'DD-MON-YYYY') >= 1;
...
WHERE e.Emp_no = a.Emp_no
AND TO_CHAR(a.Attendance_date, 'DD-mon-YYYY') = '01-jan-2019'
...
AND TO_CHAR(a.Attendance_date, 'DD-mon-YYYY') >= '01-jan-2019'
AND TO_CHAR(a.Attendance_date, 'DD-mon-YYYY') <= '31-jan-2019';
